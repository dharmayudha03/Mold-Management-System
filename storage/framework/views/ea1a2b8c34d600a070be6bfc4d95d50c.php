...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card shadow-sm border-0 mb-4" style="border-radius: 1rem;">
        <div class="card-body p-3.5">
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <form method="GET" action="<?php echo e(route('penomoran-raks.index')); ?>" class="d-flex align-items-center gap-2">
                    <div class="position-relative" style="width: 280px;">
                        ...
                        <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Cari Code Item / Rak..." 
                    ...
                    <?php if($search): ?>
                        <a href="<?php echo e(route('penomoran-raks.index')); ?>" class="btn btn-sm btn-outline-secondary font-weight-bold px-3 py-2" style="border-radius: 0.75rem;">Reset</a>
                    <?php endif; ?>
                </form>

                <?php if(!auth()->user()->hasRole('User')): ?>
                <div class="shrink-0">
                    <a href="<?php echo e(route('penomoran-raks.create')); ?>" class="btn btn-sm btn-primary font-weight-bold px-3.5 py-2" style="background-color: #2563eb; border: none; border-radius: 0.75rem;">
    ...
    <div class="card shadow-sm border-0 mb-4" id="data-table-card" style="border-radius: 1rem;">
        <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
            ...
            <span class="badge bg-light text-gray-700 border px-3 py-1.5 font-weight-bold" style="border-radius: 50rem;">Total: <?php echo e($penomoranRaks->total()); ?> Records</span>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover mb-0 text-xs">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $penomoranRaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-light text-gray-800 border px-2.5 py-1 font-weight-bold" style="border-radius: 0.5rem;">
                                        <?php echo e($item->listRak->rak ?? $item->rak ?? '-'); ?>

                                    </span>
                                </td>
                                <td class="font-weight-extrabold text-gray-900">
                                    <span class="badge bg-light text-gray-800 border px-2.5 py-1 font-weight-bold" style="border-radius: 0.5rem;">
                                        <?php echo e($item->listNoRak->norak ?? $item->norak ?? '-'); ?>
                                ...
                                <td class="text-right pr-4">
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 py-1" style="border-radius: 0.75rem; font-size: 0.8rem;">
                                            <li>
                                                <a href="<?php echo e(route('penomoran-raks.edit', $item->id)); ?>" class="dropdown-item py-1.5 px-3 text-gray-700 font-weight-bold">
                                                    <i class="fas fa-edit text-primary mr-2"></i> Edit
                                                </a>
                                            </li>
                                            <li><hr class="dropdown-divider my-1"></li>
                                            <li>
                                                <form action="<?php echo e(route('penomoran-raks.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Hapus Penomoran Rak ini?')">
            ...
            <div class="p-3 border-top bg-white"><?php echo e($penomoranRaks->links()); ?></div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project\resources\views/penomoran-raks/index.blade.php ENDPATH**/ ?>