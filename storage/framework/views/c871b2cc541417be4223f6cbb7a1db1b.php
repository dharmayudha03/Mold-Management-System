...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card shadow-sm border-0 mb-4" style="border-radius: 1rem;">
        <div class="card-body p-3.5">
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                ...
                <!-- Filter Form -->
                <form method="GET" action="<?php echo e(route('mesins.index')); ?>" class="d-flex flex-wrap align-items-center gap-2">
                    <div class="position-relative" style="width: 280px;">
                        ...
                        <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Cari No Mesin / Nama / Class..." 
                    ...
                    <?php if($search || $status): ?>
                        <a href="<?php echo e(route('mesins.index')); ?>" class="btn btn-sm btn-outline-secondary font-weight-bold px-3 py-2" style="border-radius: 0.75rem;">Reset</a>
                    <?php endif; ?>
                </form>

                <!-- Create Button -->
                <div class="shrink-0">
                    <a href="<?php echo e(route('mesins.create')); ?>" class="btn btn-sm btn-primary font-weight-bold px-3.5 py-2" style="background-color: #2563eb; border: none; border-radius: 0.75rem;">
                        <i class="fas fa-plus mr-1.5"></i> Tambah Mesin
                    </a>
                </div>
    ...
    <div class="card shadow-sm border-0 mb-4" style="border-radius: 1rem;">
        <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
            <h6 class="m-0 font-weight-extrabold text-gray-900"><i class="fas fa-cogs text-gray-700 mr-2"></i>Daftar Master Mesin Produksi</h6>
            <span class="badge bg-light text-gray-700 border px-3 py-1.5 font-weight-bold" style="border-radius: 50rem;">Total: <?php echo e($mesins->total()); ?> Records</span>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover mb-0 text-xs">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $mesins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="font-weight-bold text-gray-800">
                                    <?php echo e($item->nameMesin->name ?? '-'); ?>

                                </td>
                                <td>
                                    <span class="badge bg-light text-gray-800 border px-2.5 py-1 font-weight-bold" style="border-radius: 0.5rem;">
                                        <?php echo e($item->classMesin->class ?? '-'); ?>

                                    </span>
                                </td>
                                <td class="font-weight-semibold text-gray-700"><?php echo e($item->posisi); ?></td>
                                <td>
                                ...
                                <td class="text-right pr-4">
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 py-1" style="border-radius: 0.75rem; font-size: 0.8rem;">
                                            <li>
                                                <a href="<?php echo e(route('mesins.edit', $item->id)); ?>" class="dropdown-item py-1.5 px-3 text-gray-700 font-weight-bold">
                                                    <i class="fas fa-edit text-primary mr-2"></i> Edit
                                                </a>
                                            </li>
                                            <li><hr class="dropdown-divider my-1"></li>
                                            <li>
                                                <form action="<?php echo e(route('mesins.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus Mesin ini?')">
                                                    <?php echo csrf_field(); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="6" class="text-center text-gray-500 py-4 font-weight-bold">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project\resources\views/mesins/index.blade.php ENDPATH**/ ?>