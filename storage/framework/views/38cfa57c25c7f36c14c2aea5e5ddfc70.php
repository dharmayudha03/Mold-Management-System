...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card shadow-sm border-0 mb-4" style="border-radius: 1rem;">
        <div class="card-body p-3.5">
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                ...
                <!-- Search Form -->
                <form method="GET" action="<?php echo e(route('form-sandblastings.index')); ?>" class="d-flex align-items-center gap-2">
                    ...
                    <?php if($search): ?>
                        <a href="<?php echo e(route('form-sandblastings.index')); ?>" class="btn btn-sm btn-outline-secondary font-weight-bold px-3 py-2" style="border-radius: 0.75rem;">Reset</a>
                    <?php endif; ?>
                </form>
                ...
                <div class="d-flex align-items-center gap-2 shrink-0">
                    ...
                    <a href="<?php echo e(route('form-sandblastings.export-csv')); ?>" class="btn btn-sm btn-success font-weight-bold px-3 py-2" style="background-color: #059669; border: none; border-radius: 0.75rem;">
                        <i class="fas fa-file-csv mr-1.5"></i> Export CSV
                    </a>
                    <a href="<?php echo e(route('form-sandblastings.print-pdf')); ?>" target="_blank" class="btn btn-sm btn-warning font-weight-bold px-3 py-2 text-dark" style="background-color: #f59e0b; border: none; border-radius: 0.75rem; color: #1e293b !important;">
                        <i class="fas fa-print mr-1.5"></i> Print PDF
                    </a>
                    <?php endif; ?>
                    <?php if(!auth()->user()->hasRole('User')): ?>
                    <a href="<?php echo e(route('form-sandblastings.create')); ?>" class="btn btn-sm btn-primary font-weight-bold px-3.5 py-2" style="background-color: #2563eb; border: none; border-radius: 0.75rem;">
    ...
    <div class="card shadow-sm border-0 mb-4" id="data-table-card" style="border-radius: 1rem;">
        <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
            <h6 class="m-0 font-weight-extrabold text-gray-900"><i class="fas fa-bolt text-gray-700 mr-2"></i>Daftar Form Sandblasting Cetakan</h6>
            <span class="badge bg-light text-gray-700 border px-3 py-1.5 font-weight-bold" style="border-radius: 50rem;">Total: <?php echo e($formSandblastings->total()); ?> Records</span>
        </div>
        <div class="card-body p-0">
                ...
                <table class="table table-hover mb-0 text-xs">
                    <thead class="bg-light text-gray-900 font-weight-extrabold border-bottom">
                        <tr>
                            ...
                            <!-- Pemeriksaan Item -->
                            <th class="py-3 text-center">Sandblasting</th>
                            <th class="py-3 text-center">Cuci</th>
                            <th class="py-3 text-center">Autosol</th>
                            <th class="py-3 text-center">Gerinda/Kikir</th>
                            <th class="py-3 text-center">Oiling</th>
                            <th class="py-3 text-center">Cav NG</th>
                            <th class="py-3 text-right pr-4">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $formSandblastings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-center" style="min-width: 62px;">
                                    <?php if($item->sandblasting === '√'): ?>
                                ...
                                <td class="text-center" style="min-width: 56px;">
                                    <?php if($item->gerinda === '√'): ?>
                                        <span class="badge font-weight-extrabold px-2 py-1" style="background-color: #ecfdf5; color: #065f46; border: 1px solid #6ee7b7; border-radius: 0.5rem; font-size: 0.75rem;">√</span>
                                    <?php else: ?>
                                        <span class="badge font-weight-extrabold px-2 py-1" style="background-color: #fef2f2; color: #991b1b; border: 1px solid #fca5a5; border-radius: 0.5rem; font-size: 0.75rem;">–</span>
                                ...
                                <td class="text-center" style="min-width: 46px;">
                                    <?php if($item->oiling === '√'): ?>
                                        <span class="badge font-weight-extrabold px-2 py-1" style="background-color: #ecfdf5; color: #065f46; border: 1px solid #6ee7b7; border-radius: 0.5rem; font-size: 0.75rem;">√</span>
                                    <?php else: ?>
                                        <span class="badge font-weight-extrabold px-2 py-1" style="background-color: #fef2f2; color: #991b1b; border: 1px solid #fca5a5; border-radius: 0.5rem; font-size: 0.75rem;">–</span>
                                ...
                                <td class="text-right pr-4">
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 py-1" style="border-radius: 0.75rem; font-size: 0.8rem;">
                                            <li>
                                                <a href="<?php echo e(route('form-sandblastings.edit', $item->id)); ?>" class="dropdown-item py-1.5 px-3 text-gray-700 font-weight-bold">
                                                    <i class="fas fa-edit text-primary mr-2"></i> Edit
                                                </a>
                                            </li>
                                            <li><hr class="dropdown-divider my-1"></li>
                                            <li>
                                                <form action="<?php echo e(route('form-sandblastings.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Hapus Form Sandblasting ini?')">
                                                    <?php echo csrf_field(); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="15" class="text-center text-gray-500 py-4 font-weight-bold">
                                    Tidak ada data Form Sandblasting.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
            ...
            <div class="p-3 border-top bg-white">
                <?php echo e($formSandblastings->links()); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project\resources\views/form-sandblastings/index.blade.php ENDPATH**/ ?>