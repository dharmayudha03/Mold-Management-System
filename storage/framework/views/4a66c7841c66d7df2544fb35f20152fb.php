...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="mb-4">
            <a href="<?php echo e(route('form-setup-cetakans.index')); ?>" class="btn btn-sm btn-light border font-weight-bold px-3.5 py-2 text-gray-700 shadow-xs" style="border-radius: 0.75rem;">
        ...
        <div class="card shadow-sm border-0 mb-4" style="border-radius: 1rem;">
            ...
            <div class="card-body p-4">
                <form action="<?php echo e(route('form-setup-cetakans.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-grid-3 mb-4">
                        <div class="form-group-item">
                            ...
                            <input type="text" name="nodoc" value="<?php echo e($nodoc); ?>" readonly class="form-control font-weight-extrabold text-indigo-600 bg-light">
                        </div>
                        <div class="form-group-item">
                            ...
                            <select name="list_mesin_id" id="list_mesin_id" required class="form-select">
                                ...
                                <?php $__currentLoopData = $listMesins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option value="<?php echo e($m->id); ?>"
                                        data-occupied="<?php echo e($isOccupied ? '1' : '0'); ?>"
                                        <?php echo e(($selectedSchedule && $selectedSchedule->list_mesin_id == $m->id) ? 'selected' : ''); ?>>
                                        <?php echo e($m->code); ?><?php echo e($isOccupied ? ' (Sedang Produksi)' : ''); ?>
                    ...
                    <div class="form-grid-4 mb-4">
                        <?php $__currentLoopData = ['guidepen' => 'Guide Pen', 'busing' => 'Busing', 'baut' => 'Baut', 'core' => 'Core', 'piston' => 'Piston', 'pot' => 'Pot', 'pl' => 'PL']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-3 bg-light rounded-xl border d-flex flex-column justify-content-between" style="border-radius: 0.85rem; border: 1px solid #e2e8f0;">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="text-xs font-weight-extrabold text-gray-900 uppercase"><i class="fas fa-check-circle text-emerald-500 mr-1.5"></i><?php echo e($label); ?></span>
                                </div>
                                <select name="<?php echo e($field); ?>" required class="form-select text-xs font-weight-bold text-gray-900 bg-white" style="border-radius: 0.6rem; padding: 0.5rem 0.75rem;">
                        ...
                        <div class="p-3 bg-light rounded-xl border d-flex flex-column justify-content-between" style="border-radius: 0.85rem; border: 1px solid #e2e8f0;">
                            ...
                            <input type="number" name="cav_ng" value="<?php echo e(old('cav_ng', 0)); ?>" min="0" class="form-control text-xs font-weight-bold text-gray-900 bg-white" style="border-radius: 0.6rem; padding: 0.5rem 0.75rem;" placeholder="0">
                        </div>
                    </div>

                    <div class="pt-3 border-top d-flex align-items-center justify-content-end gap-2">
                        <a href="<?php echo e(route('form-setup-cetakans.index')); ?>" class="btn btn-sm btn-outline-secondary font-weight-bold px-4 py-2" style="border-radius: 0.75rem;">
                            Batal
                        </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const rawMesins = [
                ...
                {
                    id: "<?php echo e($m->id); ?>",
                    code: "<?php echo e($m->code); ?>",
                    isOccupied: <?php echo e($isOccupied ? 'true' : 'false'); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project\resources\views/form-setup-cetakans/create.blade.php ENDPATH**/ ?>