...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['interval' => 5000, 'containerId' => 'data-table-card']));
...
foreach (array_filter((['interval' => 5000, 'containerId' => 'data-table-card']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const containerId = "<?php echo e($containerId); ?>";
        const intervalMs = <?php echo e($interval); ?>;
...
<?php /**PATH C:\xampp\htdocs\project\resources\views/components/live-auto-refresh.blade.php ENDPATH**/ ?>