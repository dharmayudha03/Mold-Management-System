    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="card shadow-sm border-0 mb-4" style="border-radius: 1rem;">
            <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
                <h6 class="m-0 font-weight-extrabold text-gray-900"><i class="fas fa-plus-circle text-primary mr-2"></i>Form Tambah Kategori</h6>
            ...
            <div class="card-body p-4">
                <form action="{{ route('kategoris.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required placeholder="Contoh: PREVENTIVE MAINTENANCE" 
