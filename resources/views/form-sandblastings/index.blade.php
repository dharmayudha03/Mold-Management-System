        ...
        <div class="card-body p-3.5">
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                ...
                <div class="d-flex align-items-center gap-2 shrink-0">
                    ...
                    <a href="{{ route('form-sandblastings.export-csv') }}" class="btn btn-sm btn-success font-weight-bold px-3 py-2" style="background-color: #059669; border: none; border-radius: 0.75rem;">
                        <i class="fas fa-file-csv mr-1.5"></i> Export CSV
                    </a>
                    <a href="{{ route('form-sandblastings.print-pdf') }}" target="_blank" class="btn btn-sm btn-warning font-weight-bold px-3 py-2 text-dark" style="background-color: #f59e0b; border: none; border-radius: 0.75rem; color: #1e293b !important;">
