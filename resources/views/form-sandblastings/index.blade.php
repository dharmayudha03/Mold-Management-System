<x-app-layout>
    ...
    <div class="card shadow-sm border-0 mb-4" style="border-radius: 1rem;">
        <div class="card-body p-3.5">
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                ...
                <!-- Search Form -->
                <form method="GET" action="{{ route('form-sandblastings.index') }}" class="d-flex align-items-center gap-2">
                    ...
                    @if($search)
                        <a href="{{ route('form-sandblastings.index') }}" class="btn btn-sm btn-outline-secondary font-weight-bold px-3 py-2" style="border-radius: 0.75rem;">Reset</a>
                    @endif
                </form>
    ...
    <div class="modal fade" id="exportFilterModalSandblasting" tabindex="-1" role="dialog" aria-labelledby="exportFilterModalSandblastingLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 1.25rem;">
                ...
                <form id="exportFilterSandblastingForm" method="GET" action="{{ route('form-sandblastings.export-csv') }}">
                    ...
                    <div class="modal-footer bg-light border-top-0 px-4 py-3 d-flex align-items-center justify-content-end gap-2" style="border-radius: 0 0 1.25rem 1.25rem;">
                        ...
                        <button type="submit" onclick="submitSandblastingExport('pdf')" class="btn btn-sm btn-warning font-weight-bold px-3.5 py-2 text-dark" style="background-color: #f59e0b; border: none; border-radius: 0.75rem; color: #1e293b !important;">
    ...
    <script>
        ...
        function submitSandblastingExport(type) {
            ...
            if (type === 'csv') {
                form.action = "{{ route('form-sandblastings.export-csv') }}";
                form.target = "_self";
            } else {
                form.action = "{{ route('form-sandblastings.print-pdf') }}";
                form.target = "_blank";
            }
        }
    </script>
    ...
    <div class="card shadow-sm border-0 mb-4" id="data-table-card" style="border-radius: 1rem;">
        <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
            ...
            <span class="badge bg-light text-gray-700 border px-3 py-1.5 font-weight-bold" style="border-radius: 50rem;">Total: {{ $formSandblastings->total() }} Records</span>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover mb-0 text-xs">
                    ...
                    <tbody>
                        @forelse($formSandblastings as $item)
                            <tr>
                                ...
                                {{-- Pemeriksaan Item: Sandblasting --}}
                                <td class="text-center" style="min-width: 62px;">
                                    @if($item->sandblasting === '√')
                                ...
                                <td class="text-right pr-4">
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 py-1" style="border-radius: 0.75rem; font-size: 0.8rem;">
                                            <li>
                                                <a href="{{ route('form-sandblastings.edit', $item->id) }}" class="dropdown-item py-1.5 px-3 text-gray-700 font-weight-bold">
                                                    <i class="fas fa-edit text-primary mr-2"></i> Edit
                                                </a>
                                            </li>
                                            <li><hr class="dropdown-divider my-1"></li>
                                            <li>
                                                <form action="{{ route('form-sandblastings.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Hapus Form Sandblasting ini?')">
                                                    @csrf
                                                    @method('DELETE')
