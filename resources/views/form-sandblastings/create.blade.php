    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="card shadow-sm border-0 mb-4" style="border-radius: 1rem;">
            ...
            <div class="card-body p-4">
                <form action="{{ route('form-sandblastings.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-grid-3 mb-4">
                        <div class="form-group-item">
                            ...
                            <input type="text" name="nodoc" value="{{ $nodoc }}" readonly class="form-control font-weight-extrabold text-amber-600 bg-light">
                        </div>
                        <div class="form-group-item">
                        ...
                        <div class="form-group-item">
                            ...
                            <select name="list_mesin_id" id="list_mesin_id" class="form-select">
                                ...
                                @foreach($listMesins as $m)
                                    ...
                                    @endphp
                                    @if(!$isOccupied)
                                        <option value="{{ $m->id }}" {{ ($selectedSchedule && $selectedSchedule->list_mesin_id == $m->id) ? 'selected' : '' }}>{{ $m->code }}</option>
                                    @endif
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group-item">
                            ...
                            <select name="rak" id="rak" class="form-select">
                                ...
                                @foreach(array_keys($rackData) as $rName)
                                    <option value="{{ $rName }}" {{ old('rak') == $rName ? 'selected' : '' }}>{{ $rName }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group-item">
                    ...
                    <div class="form-grid-3 mb-4">
                        @foreach(['sandblasting' => 'Sandblasting', 'cuci' => 'Cuci Cetakan', 'autosol' => 'Autosol', 'gerinda' => 'Gerinda / Kikir', 'oiling' => 'Oiling'] as $field => $label)
                        ...
                        <div class="p-3 bg-light rounded-xl border d-flex flex-column justify-content-between" style="border-radius: 0.85rem; border: 1px solid #e2e8f0;">
                            ...
                            <input type="number" name="cav_ng" value="{{ old('cav_ng', 0) }}" min="0" placeholder="0" class="form-control text-xs font-weight-bold text-gray-900 bg-white" style="border-radius: 0.6rem; padding: 0.45rem 0.75rem;">
                        </div>
                    </div>
