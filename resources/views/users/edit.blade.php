    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="card shadow-sm border-0 mb-4" style="border-radius: 1rem;">
            <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
                <h6 class="m-0 font-weight-extrabold text-gray-900"><i class="fas fa-user-edit text-primary mr-2"></i>Form Edit User</h6>
                <span class="badge bg-light text-gray-700 border px-3 py-1 font-weight-bold" style="border-radius: 50rem;">Update Akun Sistem</span>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('users.update', $user->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label class="form-label text-xs font-weight-extrabold text-gray-900 uppercase">Password Baru <span class="text-gray-400 font-weight-normal">(Opsional, kosongi jika tidak diubah)</span></label>
                        <input type="password" name="password" placeholder="Kosongi jika tidak ingin mengubah password" 
                            class="form-control text-xs py-2" style="border-radius: 0.75rem;">
                    </div>

                    <div class="mb-4">
                        <label class="form-label text-xs font-weight-extrabold text-gray-900 uppercase mb-2">Role / Hak Akses Sistem</label>
                    ...
                    <div class="pt-3 border-top d-flex align-items-center justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary font-weight-bold px-4 py-2" style="border-radius: 0.75rem; background-color: #2563eb; border: none;">
                            <i class="fas fa-save mr-1.5"></i> Update User
                        </button>
                    </div>
                </form>
            </div>
