    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="card shadow-sm border-0 mb-4" style="border-radius: 1rem;">
            <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
                <h6 class="m-0 font-weight-extrabold text-gray-900"><i class="fas fa-edit text-primary mr-2"></i>Form Edit Master Code Item</h6>
            ...
            <div class="card-body p-4">
                <form action="{{ route('list-code-items.update', $listCodeItem->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ old('name', $listCodeItem->name) }}" required 
