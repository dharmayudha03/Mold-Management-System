    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="card shadow-sm border-0 mb-4" style="border-radius: 1rem;">
            <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
                <h6 class="m-0 font-weight-extrabold text-gray-900"><i class="fas fa-plus-circle text-primary mr-2"></i>Form Tambah Penomoran Rak</h6>
                <span class="badge bg-light text-gray-700 border px-3 py-1 font-weight-bold" style="border-radius: 50rem;">Input Tracking</span>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('penomoran-raks.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="form-group-item">
                            ...
                            <select name="list_no_rak_id" id="list_no_rak_id" required class="form-select">
                                ...
                                @foreach($listNoRaks as $lnr)
                                    <option value="{{ $lnr->id }}" {{ old('list_no_rak_id') == $lnr->id ? 'selected' : '' }}>{{ $lnr->norak }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="pt-3 border-top d-flex align-items-center justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary font-weight-bold px-4 py-2" style="border-radius: 0.75rem; background-color: #2563eb; border: none;">
                            <i class="fas fa-save mr-1.5"></i> Simpan Penomoran Rak
                        </button>
                    </div>
                </form>
            </div>
