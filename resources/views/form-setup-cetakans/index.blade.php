                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="row no-gutters gap-2">
                                <div class="col">
                                    ...
                                    <select name="start_code_item_id" id="setup_start_code_item_id" class="form-control text-xs custom-select" style="border-radius: 0.65rem;">
                                ...
                                <div class="col">
                                    ...
                                    <select name="end_code_item_id" id="setup_end_code_item_id" class="form-control text-xs custom-select" style="border-radius: 0.65rem;">
                                        <option value="">-- Semua Code Item --</option>
                                        @foreach($listCodeItems as $codeItem)
                                            <option value="{{ $codeItem->id }}">{{ $codeItem->name }}</option>
                                        @endforeach
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            if (typeof TomSelect !== 'undefined') {
                const startEl = document.getElementById('setup_start_code_item_id');
