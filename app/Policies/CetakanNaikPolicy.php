...
class CetakanNaikPolicy
{
    ...
    {
        return $user->can('view_any_cetakan::naik');
    }
    ...
    {
        return $user->can('view_cetakan::naik');
    }
    ...
    {
        return $user->can('create_cetakan::naik');
    }
    ...
    {
        return $user->can('update_cetakan::naik');
    }
    ...
    {
        return $user->can('delete_cetakan::naik');
    }
    ...
    {
        return $user->can('delete_any_cetakan::naik');
    }
     ...
     */
    public function replicate(User $user, CetakanNaik $cetakanNaik): bool
    {
